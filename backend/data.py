...
async def get_races(season: Union[int, str] = "current") -> list[dict]:
    ...
    if season == 2026 or season == "current":
        bahrain = {"round": 4, "name": "Bahrain Grand Prix", "circuit": "Bahrain International Circuit", "country": "Bahrain", "date": "2026-04-12", "time": "15:00:00Z", "season": 2026, "status": "待定（中东局势影响）"}
        saudi = {"round": 5, "name": "Saudi Arabian Grand Prix", "circuit": "Jeddah Corniche Circuit", "country": "Saudi Arabia", "date": "2026-04-19", "time": "17:00:00Z", "season": 2026, "status": "待定（中东局势影响）"}
