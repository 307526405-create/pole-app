Page({
  data: {
    step: 0, showCelebrate: false, canSubmit: false,
  ...
  submit() {
    ...
    setTimeout(() => {
      this.setData({ showCelebrate: false, step: 0, canSubmit: false, drivers: this.data.drivers.map(d=>({...d,selected:false})), options: [] })
